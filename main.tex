...
\input{palestra01} %Renan
\input{palestra02} %Elael
\input{palestra03} %Renan
\input{palestra04} %Elael
\input{palestra05} %Renan
\input{palestra06} %Elael
\input{palestra07} %Renan
\input{palestra08} %Renan
\input{palestra09} %Elael 
\input{palestra10} %Elael
\input{palestra11} %Elael
%\input{palestra12} %NOT
\input{palestra13} %Elael
\input{palestra14} %Elael
%\input{palestra15} %NOT
%\input{palestra16} %NOT
\input{palestra17} %Elael
\input{palestra18} %Renan
\input{palestra19} %Renan
\input{palestra20} %Renan
